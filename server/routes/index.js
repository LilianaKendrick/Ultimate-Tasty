...
// trying to help fix heroku build issue - logs indicate build succeeded but when you click the heroku link, you get the heroku application error page:
