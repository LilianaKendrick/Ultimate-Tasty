  ...
  return (
    <nav className="navbar navbar-expand-lg">
      <a className="navbar-brand" href="/">
        <img src={image} height="80px" width="80px" alt="" />
      </a>
      <div className="app-name">Tasty</div>
      <button
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav mr-auto">
          ...
          <li className="nav-item">
            <a className="nav-link" href="/favoriterecipes">
              Favorite Recipes
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="/personalrecipe">
              Personal Recipes
            </a>
          </li>
        </ul>
