...
class Ingredients extends Component {
  ...
  loadIngredients = () => {
    API.getIngredients(this.props.user.username)
      .then((res) => this.setState({ ingredients: res.data, name: "" }))
  ...
  newFave = (index) => {
    console.log(
      "Hey, I'm getting ready to save a recipe with index = " + index
    );
                      ...
                      <ListItem key={ingredients._id}>
                        <p>
                          ...
                          <input
                            ...
                            onClick={() =>
                              this.chosenIngredients(ingredients._id)
                            }
                          />{" "}
                          &emsp;
                          ...
                          <DeleteBtn
                            onClick={() =>
                              this.deleteIngredient(ingredients._id)
                            }
                          />
                        </p>
                      </ListItem>
            ...
            <div className="page-header">
              ...
              <div className="input-group mb-3">
                ...
                <input
                  type="text"
                  name="othIngr"
                  value={this.state.othIngr}
                  onChange={this.handleOthIngrChange}
